...
BOARD_MESA3D_GALLIUM_DRIVERS := kmsro r300 r600 nouveau swrast v3d vc4 etnaviv tegra svga virgl panfrost lima radeonsi
BOARD_MESA3D_VULKAN_DRIVERS := broadcom panfrost swrast virtio amd
endif
